...
🐍 **Python Backend Developer** passionate about building clean, efficient, and maintainable applications.

I'm a self-taught developer from Russia with a strong drive to continuously learn and improve. Currently diving deeper into **Django**, **FastAPI**, and **PostgreSQL**, while working on real-world projects to sharpen my skills. I believe in writing code that is not only functional but also readable and well-structured.
